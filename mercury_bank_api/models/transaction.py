...
class CountrySpecific:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "CountrySpecific":
        ...
        if data.get("countrySpecificDataCanada"):
            canada = CountrySpecificDataCanada.from_dict(data["countrySpecificDataCanada"])
        
        australia = None
        if data.get("countrySpecificDataAustralia"):
            australia = CountrySpecificDataAustralia.from_dict(data["countrySpecificDataAustralia"])
        ...
        if data.get("countrySpecificDataRussia"):
            russia = CountrySpecificDataRussia.from_dict(data["countrySpecificDataRussia"])
        
        philippines = None
        if data.get("countrySpecificDataPhilippines"):
            philippines = CountrySpecificDataPhilippines.from_dict(data["countrySpecificDataPhilippines"])
        
        south_africa = None
        if data.get("countrySpecificDataSouthAfrica"):
            south_africa = CountrySpecificDataSouthAfrica.from_dict(data["countrySpecificDataSouthAfrica"])
...
class TransactionDetails:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TransactionDetails":
        ...
        if data.get("domesticWireRoutingInfo"):
            domestic_wire = DomesticWireRoutingInfo.from_dict(data["domesticWireRoutingInfo"])
        ...
        if data.get("internationalWireRoutingInfo"):
            international_wire = InternationalWireRoutingInfo.from_dict(data["internationalWireRoutingInfo"])
...
class Transaction:
    ...
    kind: Literal[
        ...
        "creditCardCredit", "creditCardTransaction", "debitCardTransaction",
        "incomingDomesticWire", "checkDeposit", "incomingInternationalWire",
        "treasuryTransfer", "wireFee", "cardInternationalTransactionFee", "other"
    ]
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Transaction":
        ...
        if data.get("currencyExchangeInfo"):
            currency_exchange_info = CurrencyExchangeInfo.from_dict(data["currencyExchangeInfo"])
